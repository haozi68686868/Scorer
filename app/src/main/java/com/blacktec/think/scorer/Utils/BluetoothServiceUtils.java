...
///独特的UUID。
    ...
    public static BluetoothServiceUtils sInstance;
     ...
     */
    public BluetoothServiceUtils(Context context, Handler handler) {
    ...
    public static synchronized BluetoothServiceUtils getInstance(Context context, Handler handler) {
        if (sInstance == null) {
            sInstance = new BluetoothServiceUtils(context, handler);
        }
        return sInstance;
    }
    ...
    private void connectionError(String errMsg) {
        ...
        // 启动服务以重新启动侦听模式
        BluetoothServiceUtils.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                //如果接受了连接
                if (socket != null) {
                    synchronized (BluetoothServiceUtils.this) {
                        switch (mState) {
                            case STATE_LISTEN:
