...
import com.bigkoo.pickerview.view.WheelBridgeCon;
...
public class BridgePickerView<T> extends BasePickerView implements View.OnClickListener {

    private WheelBridgeCon<T> wheelOptions;
    ...
    //构造方法
    public BridgePickerView(Builder builder) {
    ...
    public static class Builder {
        private int layoutRes = R.layout.pickerview_bridge;
        private CustomListener customListener;
        ...
        private int Size_Title = 28;//标题文字大小
        private int Size_Content = 28;//内容文字大小
        ...
        public BridgePickerView build() {
            return new BridgePickerView(this);
        }
    }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.pickerview_AP) : Str_Cancel);
        ...
        wheelOptions = new WheelBridgeCon(optionsPicker, linkage);
    ...
    public void setBridgePicker(List<T> options1Items,
        ...
        wheelOptions.setBridgePicker(options1Items, options2Items, options3Items,options4Items,options5Items);
        SetCurrentItems();
    }
    public void setBridgePicker() {

        //this.setBridgePicker(BridgePickerData.directions,BridgePickerData.levels,BridgePickerData.suits,BridgePickerData.doubles,BridgePickerData.results);
    }
    ...
    public void onClick(View v) {
        ...
        if(tag.equals(TAG_CANCEL))//其实按下为All pass按钮
        {
            optionsSelectListener.onOptionsSelect(-1,0,0,0,0,clickView);
        }
        dismiss();
    }
