...
import com.bigkoo.pickerview.adapter.BridgeResultsWheelAdapter;
...
public class WheelBridgeCon<T> {
    ...
    private List<List<T>> mOptionsBridgeItems;
    ...
    public WheelBridgeCon(View view, Boolean linkage) {
        super();
        ...
        //wv_option1.setGravity(Gravity.RIGHT);
        //wv_option2.setGravity(Gravity.RIGHT);
        wv_option3.setGravity(Gravity.LEFT);
        //wv_option5.setGravity(Gravity.LEFT);
    }
    ...
    public void setPicker(List<T> options1Items,
        ...
        if(this.mOptions4Items == null)
            len=ArrayWheelAdapter.DEFAULT_LENGTH;
        ...
        wheelListener_option3 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions4Items != null) {
                    ...
                    opt2Select = opt2Select >= mOptions4Items.get(opt1Select).size() - 1 ? mOptions4Items.get(opt1Select).size() - 1 : opt2Select;
                    ...
                    wv_option4.setAdapter(new ArrayWheelAdapter(mOptions4Items
                            .get(wv_option1.getCurrentItem()).get(opt2Select).get(index)));
    ...
    public void setNPicker(List<T> options1Items,
        ...
        if (this.N_mOptions5Items == null) {
            ...
            wv_option5.setVisibility(View.VISIBLE);
        }
    }
    public void setBridgePicker(List<T> options1Items,
                           List<T> options2Items,
                           List<T> options3Items,
                           List<T> options4Items,
                           List<List<T>> options5Items) {
        setNPicker(options1Items,options2Items,options3Items,options4Items, null);
        mOptionsBridgeItems=options5Items;
        mlevel=wv_option2.getCurrentItem();
        if (mOptionsBridgeItems != null)
            wv_option5.setAdapter(new ArrayWheelAdapter(mOptionsBridgeItems.get(mlevel)));// 设置显示数据
        wv_option5.setCurrentItem(wv_option5.getCurrentItem());
        if (this.mOptionsBridgeItems == null) {
            wv_option5.setVisibility(View.GONE);
        } else {
            wv_option5.setVisibility(View.VISIBLE);
        }
        wheelListener_option2 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                int opt5=0;
                if (mOptionsBridgeItems!= null) {
                    opt5=wv_option5.getCurrentItem();
                    opt5=opt5-mlevel+index;
                    opt5=opt5<0?0:opt5>13?13:opt5;
                    wv_option5.setAdapter(new ArrayWheelAdapter(mOptionsBridgeItems.get(index)));
                    wv_option5.setCurrentItem(opt5);
                }
                mlevel=index;
            }
        };
    ...
    public int[] getCurrentItems() {
        ...
        if (mOptions4Items!=null&&mOptions4Items.size()>0){//非空判断
            currentItems[3] = wv_option4.getCurrentItem()>(mOptions4Items.get(currentItems[0]).get(currentItems[1]).get(currentItems[2]).size()-1)?0:wv_option3.getCurrentItem();
        }else {
    ...
    public void setCurrentItems(int option1, int option2, int option3, int option4, int option5) {
        ...
        if(mOptionsBridgeItems!=null) {
            mlevel =option2;
            wv_option5.setAdapter(new ArrayWheelAdapter(mOptionsBridgeItems.get(mlevel)));
        }
